...
# пробелом. Каждое слово состоит из латинских букв в нижнем регистре. Сделать вывод исходной строки,
...
text = input("Введіть рядок з маленьких лат.букв: ").split()
print(int_func(text))
